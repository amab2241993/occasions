<?php
	...
	// if (isset($_SESSION['user_name'])) {
		$pageTitle = 'Nour Aldaem';
		$getH3 = 'تقرير نور الدائم';
		include '../../init.php';
		?><script src="<?php echo $controller ?>reports/nourAldaem.js"></script><?php
	...
	<?php
		...
		$result4   = intval(($profits*35)/100);
		$result7   = intval(($profitNew*35)/100);
		$all       = intval($result7) - intval($creditor);
	?>
	<table id="nourAldaem" class="table table-striped table-bordered">
