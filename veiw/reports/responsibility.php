<?php
	...
	<?php
		...
		$result4   = intval(($profits*5)/100);
		$result7   = intval(($profitNew*5)/100);
		$all       = intval($result7) - intval($creditor);
	?>
	<table id="responsibility" class="table table-striped table-bordered">
