<?php
	...
	// if (isset($_SESSION['user_name'])) {
		$pageTitle = 'Syed Ahmed';
		$getH3 = 'تقرير سيد احمد';
		include '../../init.php';
		?><script src="<?php echo $controller ?>reports/syedAhmed.js"></script><?php
	...
	?>
	<table id="syedAhmed" class="table table-striped table-bordered">
